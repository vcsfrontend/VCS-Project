...
export class SwitherService {
  ...
  generatedOutputJson(value:any): Observable<any> { return this.http.get(`${this.adonaiURL}enterprise/generatedOutputJson/${value}`); }
  ...
  optimizeImportData(data: any): Observable<any> { return this.http.post(`${this.adonaiURL}enterprise/optimize`, data); }
